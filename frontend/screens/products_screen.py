...
class ProductsScreen(QWidget):
    ...
    def init_products_tab(self):
        ...
        self.prod_table.horizontalHeader().setSectionResizeMode(9, QHeaderView.Fixed)
        self.prod_table.setColumnWidth(9, 190)
    ...
    def init_categories_tab(self):
        ...
        self.cat_table.horizontalHeader().setSectionResizeMode(2, QHeaderView.Fixed)
        self.cat_table.setColumnWidth(2, 100)
        ...
        self.subcat_table.horizontalHeader().setSectionResizeMode(3, QHeaderView.Fixed)
        self.subcat_table.setColumnWidth(3, 100)
    ...
    def init_brands_tab(self):
        ...
        self.brand_table.horizontalHeader().setSectionResizeMode(3, QHeaderView.Fixed)
    ...
    def init_units_tab(self):
        ...
        self.unit_table.horizontalHeader().setSectionResizeMode(2, QHeaderView.Fixed)
        self.unit_table.setColumnWidth(2, 100)
